...
var ReactiveElement = class extends HTMLElement {
  ...
  __initialize() {
    ...
    this.requestUpdate();
    (_a = this.constructor._initializers) == null ? void 0 : _a.forEach((i) => i(this));
  }
  /**
  ...
  addController(controller) {
    ...
    if (this.renderRoot !== void 0 && this.isConnected) {
      (_a = controller.hostConnected) == null ? void 0 : _a.call(controller);
    }
  }
  /**
  ...
  removeController(controller) {
    var _a;
    (_a = this.__controllers) == null ? void 0 : _a.delete(controller);
  }
  /**
  ...
  connectedCallback() {
    ...
    (_a = this.__controllers) == null ? void 0 : _a.forEach((c) => {
      var _a2;
      return (_a2 = c.hostConnected) == null ? void 0 : _a2.call(c);
    });
  }
  /**
  ...
  disconnectedCallback() {
    ...
    (_a = this.__controllers) == null ? void 0 : _a.forEach((c) => {
      var _a2;
      return (_a2 = c.hostDisconnected) == null ? void 0 : _a2.call(c);
    });
  }
  /**
  ...
  __propertyToAttribute(name, value) {
    ...
    if (attr !== void 0 && options.reflect === true) {
      const converter = ((_a = options.converter) == null ? void 0 : _a.toAttribute) !== void 0 ? options.converter : defaultConverter;
  ...
  _$attributeToProperty(name, value) {
    ...
    if (propName !== void 0 && this.__reflectingProperty !== propName) {
      ...
      const converter = typeof options.converter === "function" ? { fromAttribute: options.converter } : ((_a = options.converter) == null ? void 0 : _a.fromAttribute) !== void 0 ? options.converter : defaultConverter;
      this.__reflectingProperty = propName;
      this[propName] = converter.fromAttribute(value, options.type) ?? ((_b = this.__defaultValues) == null ? void 0 : _b.get(propName)) ?? // eslint-disable-next-line @typescript-eslint/no-explicit-any
      null;
      this.__reflectingProperty = null;
    }
  }
  ...
  requestUpdate(name, oldValue, options) {
    ...
    if (name !== void 0) {
      ...
      options.useDefault && options.reflect && newValue === ((_a = this.__defaultValues) == null ? void 0 : _a.get(name)) && !this.hasAttribute(ctor.__attributeNameForProperty(name, options));
      if (changed) {
  ...
  performUpdate() {
    ...
    try {
      ...
      if (shouldUpdate) {
        ...
        (_a = this.__controllers) == null ? void 0 : _a.forEach((c) => {
          var _a2;
          return (_a2 = c.hostUpdate) == null ? void 0 : _a2.call(c);
        });
  ...
  _$didUpdate(changedProperties) {
    ...
    (_a = this.__controllers) == null ? void 0 : _a.forEach((c) => {
      var _a2;
      return (_a2 = c.hostUpdated) == null ? void 0 : _a2.call(c);
    });
    if (!this.hasUpdated) {
...
@lit/reactive-element/development/reactive-element.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-PQZREUCN.js.map
